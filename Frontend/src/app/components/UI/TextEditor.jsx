...
//   useEffect(() => {
//     const s = socketIOClient("http://localhost:8080");
//     setSocket(s);
//     return () => {
//       s.disconnect();
//     };
...
//       const resolvedDocument = resolveConflicts(document, localVersions);
//       quill.setContents(JSON.parse(resolvedDocument));
//     });
...
//     const interval = setInterval(() => {
//       socket.emit("send-changes", JSON.stringify(quill.getContents()));
//     }, SAVE_INTERVAL_MS);
